...
async function displayMovies() {
    ...
    await fetchAndDisplayMoviesFromTMDB('horror', 'movie', apiKey, '27');
    await fetchAndDisplayMoviesFromTMDB('comedy', 'movie', apiKey, '35');
    await fetchAndDisplayMoviesFromTMDB('romance', 'movie', apiKey, '10749');
}
